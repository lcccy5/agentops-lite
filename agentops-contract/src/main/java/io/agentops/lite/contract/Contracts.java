...
public final class Contracts {
  ...
  public record UsageLedgerEvent(
      String ledgerId,
      String projectId,
  ...
  public record ResolvePromptRequest(
      @NotBlank String environment, @NotBlank String subjectKey, String forcedVersion) {}
  ...
  public record CreateReleaseRequest(
      ...
      @NotNull Integer canaryPercent,
      @NotBlank String gateResultId) {}

  /** Imports one named collection of deterministic evaluation cases. */
  public record ImportDatasetRequest(
      @NotBlank String name, @NotNull List<EvalCaseDefinition> cases) {}

  /** Defines observable expectations without using an LLM judge. */
  public record EvalCaseDefinition(
      @NotBlank String caseId,
      @NotBlank String question,
      @NotBlank String fixtureId,
  ...
  public record AgentEvalRequest(
      String caseId, String promptVersion, String question, String fixtureId) {}

  /** Structured observations used by deterministic scoring. */
  public record AgentEvalObservation(
      String runId,
      String answer,
      List<ToolObservation> tools,
